...
Migration notes: treesitter moved from master to main (A); lua_ls fixes applied (bd53f28 + b01d052); gitsigns/minimal/other small fixes reviewed but skipped where config differs.
